...
export const  createFormTemplate = (tasks) => {
  ...
  const createOffersRender = () => {
    ...
    for (let i = 0; i < offers.offer.length; i++) {
      ...
      offerBlocks.push(`<div class="event__offer-selector">
      <input class="event__offer-checkbox  visually-hidden" id="event-offer-${bend}-2" type="checkbox" name="event-offer-${bend}" ${isChecked()}>
      <label class="event__offer-label" for="event-offer-${bend}-2">
